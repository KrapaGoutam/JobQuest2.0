...
**Amendment:** Option B is specified in [`GATE_03_AUTH_OPTION_B_AMENDMENT.md`](GATE_03_AUTH_OPTION_B_AMENDMENT.md) (PROPOSED; M1B). Where the two conflict, the amendment wins once approved.  
